        ...
        <div className="relative container mx-auto px-4 py-20 z-10">
          ...
          >
            <motion.div
              ...
              className="mb-8"
            >
              <div className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 backdrop-blur-xl rounded-full border border-white/20 shadow-2xl">
                <motion.div
                  animate={{ rotate: 360 }}
                ...
                <span className="text-sm font-semibold text-white">Advanced Phishing Detection</span>
              </div>
            </motion.div>
